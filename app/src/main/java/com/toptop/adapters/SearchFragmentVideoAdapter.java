...
public class SearchFragmentVideoAdapter extends  RecyclerView.Adapter<SearchFragmentVideoAdapter.SearchViewHolder>  {
    ...
    @Override
    public void onViewAttachedToWindow(@NonNull SearchFragmentVideoAdapter.SearchViewHolder holder) {
    ...
    public SearchViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SearchFragmentVideoAdapter.SearchViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull SearchViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((MainActivity) context).goToVideo(video);
            }
        });
    }
