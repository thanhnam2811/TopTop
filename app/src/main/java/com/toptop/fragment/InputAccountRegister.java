 ...
 * Use the {@link InputAccountRegister#newInstance} factory method to
...
public class InputAccountRegister extends Fragment {
     ...
     * @return A new instance of fragment InputAccountRegister.
     */
    // TODO: Rename and change types and number of parameters
    public static InputAccountRegister newInstance(String param1, String param2) {
        InputAccountRegister fragment = new InputAccountRegister();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnBack.setOnClickListener(v -> requireActivity().getSupportFragmentManager().beginTransaction()
                .replace(R.id.input_fragment, requireActivity().getSupportFragmentManager().findFragmentByTag(InputInfoRegister.TAG))
                .commit());
